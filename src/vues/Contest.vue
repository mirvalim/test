  ...
  <div class="q-pa-md">
    ...
    <el-drawer
      ...
      <div>
        ...
        <el-input placeholder="starteDate" v-model="input.starteDate"></el-input>
...
export default {
  ...
  methods: {
    ...
    saqlash(){
      if (this.input.name === "" && this.input.starteDate === ""&& this.input.description === "" && this.input.userId === ""){
        return
      }
